...
CREATE TABLE IF NOT EXISTS atomic.com_mandrill_message_soft_bounced_1 (
    ...
    "msg.bgtools_code"       DOUBLE PRECISION ENCODE RAW,
    "msg.bounce_description" VARCHAR(4096)    ENCODE LZO,
    "msg.diag"               VARCHAR(4096)    ENCODE LZO,
...
COMMENT ON TABLE atomic.com_mandrill_message_soft_bounced_1 IS 'iglu:com.mandrill/message_soft_bounced/jsonschema/1-0-0';
