...
CREATE TABLE IF NOT EXISTS atomic.com_mandrill_message_delayed_1 (
...
COMMENT ON TABLE atomic.com_mandrill_message_delayed_1 IS 'iglu:com.mandrill/message_delayed/jsonschema/1-0-0';
