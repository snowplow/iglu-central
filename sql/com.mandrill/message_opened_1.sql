...
CREATE TABLE IF NOT EXISTS atomic.com_mandrill_message_opened_1 (
...
COMMENT ON TABLE atomic.com_mandrill_message_opened_1 IS 'iglu:com.mandrill/message_opened/jsonschema/1-0-0';
