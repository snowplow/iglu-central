...
CREATE TABLE IF NOT EXISTS atomic.com_getvero_bounced_1 (
    ...
    "bounce_code"            VARCHAR(64)   ENCODE ZSTD,
...
COMMENT ON TABLE atomic.com_getvero_bounced_1 IS 'iglu:com.getvero/bounced/jsonschema/1-0-0';
