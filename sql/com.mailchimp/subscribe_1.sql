...
CREATE TABLE IF NOT EXISTS atomic.com_mailchimp_subscribe_1 (
    ...
    "data.ip_signup"        VARCHAR(4096) ENCODE LZO,
...
COMMENT ON TABLE atomic.com_mailchimp_subscribe_1 IS 'iglu:com.mailchimp/subscribe/jsonschema/1-0-0';
