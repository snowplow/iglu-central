...
CREATE TABLE IF NOT EXISTS atomic.com_snowplowanalytics_snowplow_cookie_extractor_config_1 (
    ...
    "parameters.cookies" VARCHAR(5000) ENCODE LZO       NOT NULL,
...
COMMENT ON TABLE atomic.com_snowplowanalytics_snowplow_cookie_extractor_config_1 IS 'iglu:com.snowplowanalytics.snowplow/cookie_extractor_config/jsonschema/1-0-0';
