...
CREATE TABLE IF NOT EXISTS atomic.com_hubspot_company_change_1 (
    ...
    "property_name"   VARCHAR(255)  ENCODE ZSTD,
    "property_value"  VARCHAR(255)  ENCODE ZSTD,
...
COMMENT ON TABLE atomic.com_hubspot_company_change_1 IS 'iglu:com.hubspot/company_change/jsonschema/1-0-0';
