...
CREATE TABLE IF NOT EXISTS atomic.com_hubspot_company_deletion_1 (
...
COMMENT ON TABLE atomic.com_hubspot_company_deletion_1 IS 'iglu:com.hubspot/company_deletion/jsonschema/1-0-0';
