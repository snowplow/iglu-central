...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_group_unsubscribe_2 (
...
COMMENT ON TABLE atomic.com_sendgrid_group_unsubscribe_2 IS 'iglu:com.sendgrid/group_unsubscribe/jsonschema/2-0-0';
