...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_deferred_2 (
    ...
    "attempt"                            VARCHAR(4096) ENCODE ZSTD,
    "category"                           VARCHAR(5000) ENCODE ZSTD,
    "cert_error"                         VARCHAR(4096) ENCODE ZSTD,
    ...
    "response"                           VARCHAR(4096) ENCODE ZSTD,
...
COMMENT ON TABLE atomic.com_sendgrid_deferred_2 IS 'iglu:com.sendgrid/deferred/jsonschema/2-0-0';
