...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_spamreport_2 (
...
COMMENT ON TABLE atomic.com_sendgrid_spamreport_2 IS 'iglu:com.sendgrid/spamreport/jsonschema/2-0-0';
