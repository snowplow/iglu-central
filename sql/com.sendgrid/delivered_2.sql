...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_delivered_2 (
...
COMMENT ON TABLE atomic.com_sendgrid_delivered_2 IS 'iglu:com.sendgrid/delivered/jsonschema/2-0-0';
