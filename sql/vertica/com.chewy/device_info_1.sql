...
-- Generated: 2017-10-21 13:59
 
CREATE SCHEMA IF NOT EXISTS atomic;
 
CREATE TABLE IF NOT EXISTS atomic.com_chewy_device_info_1 (
    ...
    device_model                      varchar(4096) null               encoding gzip_comp,
    ...
    is_tablet                         varchar(4096) null               encoding gzip_comp,
    ...
    os_version                        varchar(4096) null               encoding gzip_comp,
    ...
    roku_advertising_id               varchar(4096) null               encoding gzip_comp,
    roku_publisher_id                 varchar(4096) null               encoding gzip_comp,
    screen_dpi                        smallint      null               encoding gzip_comp,
    screen_height                     bigint        null               encoding gzip_comp,
    screen_width                      bigint        null               encoding gzip_comp,
    supports_telephony                varchar(4096) null               encoding gzip_comp,
    timezone_offset                   bigint        null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_chewy_device_info_1 IS 'iglu:com.chewy/device_info/jsonschema/1-0-0';