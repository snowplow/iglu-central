...
CREATE TABLE IF NOT EXISTS atomic.com_chewy_user_attribute_change_1 (
    ...
    user_attribute_name varchar(256) null               encoding gzip_comp,
    old_value           varchar(256) null               encoding gzip_comp,
    new_value           varchar(256) null               encoding gzip_comp,
    is_new_attribute    boolean      null               encoding auto,
...
COMMENT ON TABLE atomic.com_chewy_user_attribute_change_1 IS 'iglu:com.chewy/user_attribute_change/jsonschema/1-0-0';
