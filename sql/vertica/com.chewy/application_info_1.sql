CREATE TABLE IF NOT EXISTS atomic.com_chewy_application_info_1 (
    ...
    application_name    varchar(4096) null               encoding gzip_comp,
    ...
    apple_search_ads_attributes varchar(4096)	null	encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_chewy_application_info_1 IS 'iglu:com.chewy/application_info/jsonschema/1-0-0';