...
CREATE TABLE IF NOT EXISTS atomic.com_chewy_product_1 (
    ...
    has_extended_content     varchar(4096)    null               encoding gzip_comp,
    has_video                varchar(4096)    null               encoding gzip_comp,
    ...
    on_sale_item             varchar(4096)    null               encoding gzip_comp,
    ...
    recurring_item           varchar(4096)    null               encoding gzip_comp,
    ...
    extended_content_list    varchar(512)     null               encoding gzip_comp,
    new_item                 varchar(16)      null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_chewy_product_1 IS 'iglu:com.chewy/product/jsonschema/1-0-0';
