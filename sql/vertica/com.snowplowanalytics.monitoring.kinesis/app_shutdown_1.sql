CREATE TABLE IF NOT EXISTS atomic.com_snowplowanalytics_monitoring_kinesis_app_shutdown_1 (
	-- Schema of this type
...
COMMENT ON TABLE atomic.com_snowplowanalytics_monitoring_kinesis_app_shutdown_1 IS 'iglu:com.snowplowanalytics.monitoring.kinesis/app_shutdown/jsonschema/1-0-0';