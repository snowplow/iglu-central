CREATE TABLE IF NOT EXISTS atomic.com_snowplowanalytics_monitoring_batch_emr_job_status_1 (
	...
	jobflow_id  		varchar(255)		not null    		encoding gzip_comp   ,
	state       		varchar(255)		not null    		encoding gzip_comp   ,
	created_at  		varchar(255)		not null    		encoding gzip_comp   ,
	ended_at    		varchar(255)		null        		encoding gzip_comp   ,
	last_state_change_reason		varchar(255)		null        		encoding gzip_comp   
)
ORDER BY
	schema_vendor,
	schema_name,
