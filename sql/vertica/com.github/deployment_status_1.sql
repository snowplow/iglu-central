...
CREATE TABLE IF NOT EXISTS atomic.com_github_deployment_status_1 (
    ...
    deployment_created_at                         timestamp     null               encoding gzip_comp,
    deployment_creator_avatar_url                 varchar(4096) null               encoding gzip_comp,
    deployment_creator_events_url                 varchar(4096) null               encoding gzip_comp,
    deployment_creator_followers_url              varchar(4096) null               encoding gzip_comp,
    deployment_creator_following_url              varchar(4096) null               encoding gzip_comp,
    deployment_creator_gists_url                  varchar(4096) null               encoding gzip_comp,
    deployment_creator_gravatar_id                varchar(4096) null               encoding gzip_comp,
    deployment_creator_html_url                   varchar(4096) null               encoding gzip_comp,
    deployment_creator_id                         int           null               encoding gzip_comp,
    deployment_creator_login                      varchar(4096) null               encoding gzip_comp,
    deployment_creator_organizations_url          varchar(4096) null               encoding gzip_comp,
    deployment_creator_received_events_url        varchar(4096) null               encoding gzip_comp,
    deployment_creator_repos_url                  varchar(4096) null               encoding gzip_comp,
    deployment_creator_site_admin                 boolean       null               encoding auto,
    deployment_creator_starred_url                varchar(4096) null               encoding gzip_comp,
    deployment_creator_subscriptions_url          varchar(4096) null               encoding gzip_comp,
    deployment_creator_type                       varchar(4096) null               encoding gzip_comp,
    deployment_creator_url                        varchar(4096) null               encoding gzip_comp,
    deployment_description                        varchar(4096) null               encoding gzip_comp,
    deployment_environment                        varchar(4096) null               encoding gzip_comp,
    deployment_id                                 int           null               encoding gzip_comp,
    deployment_ref                                varchar(4096) null               encoding gzip_comp,
    deployment_repository_url                     varchar(4096) null               encoding gzip_comp,
    deployment_sha                                varchar(4096) null               encoding gzip_comp,
    deployment_statuses_url                       varchar(4096) null               encoding gzip_comp,
    deployment_task                               varchar(4096) null               encoding gzip_comp,
    deployment_updated_at                         timestamp     null               encoding gzip_comp,
    deployment_url                                varchar(4096) null               encoding gzip_comp,
    deployment_status_created_at                  timestamp     null               encoding gzip_comp,
    deployment_status_creator_avatar_url          varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_events_url          varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_followers_url       varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_following_url       varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_gists_url           varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_gravatar_id         varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_html_url            varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_id                  int           null               encoding gzip_comp,
    deployment_status_creator_login               varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_organizations_url   varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_received_events_url varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_repos_url           varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_site_admin          boolean       null               encoding auto,
    deployment_status_creator_starred_url         varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_subscriptions_url   varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_type                varchar(4096) null               encoding gzip_comp,
    deployment_status_creator_url                 varchar(4096) null               encoding gzip_comp,
    deployment_status_deployment_url              varchar(4096) null               encoding gzip_comp,
    deployment_status_description                 varchar(4096) null               encoding gzip_comp,
    deployment_status_id                          int           null               encoding gzip_comp,
    deployment_status_repository_url              varchar(4096) null               encoding gzip_comp,
    deployment_status_state                       varchar(4096) null               encoding gzip_comp,
    deployment_status_target_url                  varchar(4096) null               encoding gzip_comp,
    deployment_status_updated_at                  timestamp     null               encoding gzip_comp,
    deployment_status_url                         varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_deployment_status_1 IS 'iglu:com.github/deployment_status/jsonschema/1-0-0';
