...
CREATE TABLE IF NOT EXISTS atomic.com_github_create_1 (
    ...
    master_branch                        varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_create_1 IS 'iglu:com.github/create/jsonschema/1-0-0';
