...
CREATE TABLE IF NOT EXISTS atomic.com_github_delete_1 (
    ...
    pusher_type                          varchar(4096) null               encoding gzip_comp,
    ref                                  varchar(4096) null               encoding gzip_comp,
    ref_type                             varchar(4096) null               encoding gzip_comp,
    ...
    repository_forks                     bigint        null               encoding gzip_comp,
    repository_forks_count               bigint        null               encoding gzip_comp,
    ...
    repository_id                        bigint        null               encoding gzip_comp,
    ...
    repository_open_issues               bigint        null               encoding gzip_comp,
    repository_open_issues_count         bigint        null               encoding gzip_comp,
    ...
    repository_owner_id                  bigint        null               encoding gzip_comp,
    ...
    repository_size                      bigint        null               encoding gzip_comp,
    repository_ssh_url                   varchar(4096) null               encoding gzip_comp,
    repository_stargazers_count          bigint        null               encoding gzip_comp,
    ...
    repository_watchers                  bigint        null               encoding gzip_comp,
    repository_watchers_count            bigint        null               encoding gzip_comp,
    ...
    sender_id                            bigint        null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_delete_1 IS 'iglu:com.github/delete/jsonschema/1-0-0';
