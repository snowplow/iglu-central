...
CREATE TABLE IF NOT EXISTS atomic.com_github_deployment_1 (
...
COMMENT ON TABLE atomic.com_github_deployment_1 IS 'iglu:com.github/deployment/jsonschema/1-0-0';
