...
CREATE TABLE IF NOT EXISTS atomic.com_github_membership_1 (
    ...
    member_avatar_url               varchar(4096) null               encoding gzip_comp,
    member_events_url               varchar(4096) null               encoding gzip_comp,
    member_followers_url            varchar(4096) null               encoding gzip_comp,
    member_following_url            varchar(4096) null               encoding gzip_comp,
    member_gists_url                varchar(4096) null               encoding gzip_comp,
    member_gravatar_id              varchar(4096) null               encoding gzip_comp,
    member_html_url                 varchar(4096) null               encoding gzip_comp,
    member_id                       smallint      null               encoding gzip_comp,
    member_login                    varchar(4096) null               encoding gzip_comp,
    member_organizations_url        varchar(4096) null               encoding gzip_comp,
    member_received_events_url      varchar(4096) null               encoding gzip_comp,
    member_repos_url                varchar(4096) null               encoding gzip_comp,
    member_site_admin               boolean       null               encoding auto,
    member_starred_url              varchar(4096) null               encoding gzip_comp,
    member_subscriptions_url        varchar(4096) null               encoding gzip_comp,
    member_type                     varchar(4096) null               encoding gzip_comp,
    member_url                      varchar(4096) null               encoding gzip_comp,
    ...
    scope                           varchar(4096) null               encoding gzip_comp,
    ...
    team_id                         int           null               encoding gzip_comp,
    team_members_url                varchar(4096) null               encoding gzip_comp,
    team_name                       varchar(4096) null               encoding gzip_comp,
    team_permission                 varchar(4096) null               encoding gzip_comp,
    team_repositories_url           varchar(4096) null               encoding gzip_comp,
    team_slug                       varchar(4096) null               encoding gzip_comp,
    team_url                        varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_membership_1 IS 'iglu:com.github/membership/jsonschema/1-0-0';
