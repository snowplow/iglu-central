...
CREATE TABLE IF NOT EXISTS atomic.com_github_milestone_1 (
    ...
    milestone_closed_at                   varchar(4096) null               encoding gzip_comp,
    milestone_closed_issues               smallint      null               encoding gzip_comp,
    milestone_created_at                  timestamp     null               encoding gzip_comp,
    milestone_creator_avatar_url          varchar(4096) null               encoding gzip_comp,
    milestone_creator_events_url          varchar(4096) null               encoding gzip_comp,
    milestone_creator_followers_url       varchar(4096) null               encoding gzip_comp,
    milestone_creator_following_url       varchar(4096) null               encoding gzip_comp,
    milestone_creator_gists_url           varchar(4096) null               encoding gzip_comp,
    milestone_creator_gravatar_id         varchar(4096) null               encoding gzip_comp,
    milestone_creator_html_url            varchar(4096) null               encoding gzip_comp,
    milestone_creator_id                  int           null               encoding gzip_comp,
    milestone_creator_login               varchar(4096) null               encoding gzip_comp,
    milestone_creator_organizations_url   varchar(4096) null               encoding gzip_comp,
    milestone_creator_received_events_url varchar(4096) null               encoding gzip_comp,
    milestone_creator_repos_url           varchar(4096) null               encoding gzip_comp,
    milestone_creator_site_admin          boolean       null               encoding auto,
    milestone_creator_starred_url         varchar(4096) null               encoding gzip_comp,
    milestone_creator_subscriptions_url   varchar(4096) null               encoding gzip_comp,
    milestone_creator_type                varchar(4096) null               encoding gzip_comp,
    milestone_creator_url                 varchar(4096) null               encoding gzip_comp,
    milestone_description                 varchar(4096) null               encoding gzip_comp,
    milestone_due_on                      varchar(4096) null               encoding gzip_comp,
    milestone_html_url                    varchar(4096) null               encoding gzip_comp,
    milestone_id                          int           null               encoding gzip_comp,
    milestone_labels_url                  varchar(4096) null               encoding gzip_comp,
    milestone_number                      smallint      null               encoding gzip_comp,
    milestone_open_issues                 smallint      null               encoding gzip_comp,
    milestone_state                       varchar(4096) null               encoding gzip_comp,
    milestone_title                       varchar(4096) null               encoding gzip_comp,
    milestone_updated_at                  timestamp     null               encoding gzip_comp,
    milestone_url                         varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_milestone_1 IS 'iglu:com.github/milestone/jsonschema/1-0-0';
