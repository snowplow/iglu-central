...
CREATE TABLE IF NOT EXISTS atomic.com_github_status_1 (
    ...
    branches                             varchar(5000) null               encoding gzip_comp,
    commit_author_avatar_url             varchar(4096) null               encoding gzip_comp,
    commit_author_events_url             varchar(4096) null               encoding gzip_comp,
    commit_author_followers_url          varchar(4096) null               encoding gzip_comp,
    commit_author_following_url          varchar(4096) null               encoding gzip_comp,
    commit_author_gists_url              varchar(4096) null               encoding gzip_comp,
    commit_author_gravatar_id            varchar(4096) null               encoding gzip_comp,
    commit_author_html_url               varchar(4096) null               encoding gzip_comp,
    commit_author_id                     int           null               encoding gzip_comp,
    commit_author_login                  varchar(4096) null               encoding gzip_comp,
    commit_author_organizations_url      varchar(4096) null               encoding gzip_comp,
    commit_author_received_events_url    varchar(4096) null               encoding gzip_comp,
    commit_author_repos_url              varchar(4096) null               encoding gzip_comp,
    commit_author_site_admin             boolean       null               encoding auto,
    commit_author_starred_url            varchar(4096) null               encoding gzip_comp,
    commit_author_subscriptions_url      varchar(4096) null               encoding gzip_comp,
    commit_author_type                   varchar(4096) null               encoding gzip_comp,
    commit_author_url                    varchar(4096) null               encoding gzip_comp,
    commit_comments_url                  varchar(4096) null               encoding gzip_comp,
    commit_commit_author_date            timestamp     null               encoding gzip_comp,
    commit_commit_author_email           varchar(4096) null               encoding gzip_comp,
    commit_commit_author_name            varchar(4096) null               encoding gzip_comp,
    commit_commit_comment_count          smallint      null               encoding gzip_comp,
    commit_commit_committer_date         timestamp     null               encoding gzip_comp,
    commit_commit_committer_email        varchar(4096) null               encoding gzip_comp,
    commit_commit_committer_name         varchar(4096) null               encoding gzip_comp,
    commit_commit_message                varchar(4096) null               encoding gzip_comp,
    commit_commit_tree_sha               varchar(4096) null               encoding gzip_comp,
    commit_commit_tree_url               varchar(4096) null               encoding gzip_comp,
    commit_commit_url                    varchar(4096) null               encoding gzip_comp,
    commit_committer_avatar_url          varchar(4096) null               encoding gzip_comp,
    commit_committer_events_url          varchar(4096) null               encoding gzip_comp,
    commit_committer_followers_url       varchar(4096) null               encoding gzip_comp,
    commit_committer_following_url       varchar(4096) null               encoding gzip_comp,
    commit_committer_gists_url           varchar(4096) null               encoding gzip_comp,
    commit_committer_gravatar_id         varchar(4096) null               encoding gzip_comp,
    commit_committer_html_url            varchar(4096) null               encoding gzip_comp,
    commit_committer_id                  int           null               encoding gzip_comp,
    commit_committer_login               varchar(4096) null               encoding gzip_comp,
    commit_committer_organizations_url   varchar(4096) null               encoding gzip_comp,
    commit_committer_received_events_url varchar(4096) null               encoding gzip_comp,
    commit_committer_repos_url           varchar(4096) null               encoding gzip_comp,
    commit_committer_site_admin          boolean       null               encoding auto,
    commit_committer_starred_url         varchar(4096) null               encoding gzip_comp,
    commit_committer_subscriptions_url   varchar(4096) null               encoding gzip_comp,
    commit_committer_type                varchar(4096) null               encoding gzip_comp,
    commit_committer_url                 varchar(4096) null               encoding gzip_comp,
    commit_html_url                      varchar(4096) null               encoding gzip_comp,
    commit_parents                       varchar(5000) null               encoding gzip_comp,
    commit_sha                           varchar(4096) null               encoding gzip_comp,
    commit_url                           varchar(4096) null               encoding gzip_comp,
    context                              varchar(4096) null               encoding gzip_comp,
    created_at                           timestamp     null               encoding gzip_comp,
    description                          varchar(4096) null               encoding gzip_comp,
    id                                   int           null               encoding gzip_comp,
    name                                 varchar(4096) null               encoding gzip_comp,
    ...
    sha                                  varchar(4096) null               encoding gzip_comp,
    state                                varchar(4096) null               encoding gzip_comp,
    target_url                           varchar(4096) null               encoding gzip_comp,
    updated_at                           timestamp     null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_status_1 IS 'iglu:com.github/status/jsonschema/1-0-0';
