...
CREATE TABLE IF NOT EXISTS atomic.com_github_repository_1 (
...
COMMENT ON TABLE atomic.com_github_repository_1 IS 'iglu:com.github/repository/jsonschema/1-0-0';
