...
CREATE TABLE IF NOT EXISTS atomic.com_github_project_column_1 (
    ...
    project_column_cards_url             varchar(4096) null               encoding gzip_comp,
    project_column_created_at            timestamp     null               encoding gzip_comp,
    project_column_id                    int           null               encoding gzip_comp,
    project_column_name                  varchar(4096) null               encoding gzip_comp,
    project_column_project_url           varchar(4096) null               encoding gzip_comp,
    project_column_updated_at            timestamp     null               encoding gzip_comp,
    project_column_url                   varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_project_column_1 IS 'iglu:com.github/project_column/jsonschema/1-0-0';
