...
CREATE TABLE IF NOT EXISTS atomic.com_github_project_card_1 (
    ...
    project_card_column_id                   int           null               encoding gzip_comp,
    project_card_column_url                  varchar(4096) null               encoding gzip_comp,
    project_card_content_url                 varchar(4096) null               encoding gzip_comp,
    project_card_created_at                  timestamp     null               encoding gzip_comp,
    project_card_creator_avatar_url          varchar(4096) null               encoding gzip_comp,
    project_card_creator_events_url          varchar(4096) null               encoding gzip_comp,
    project_card_creator_followers_url       varchar(4096) null               encoding gzip_comp,
    project_card_creator_following_url       varchar(4096) null               encoding gzip_comp,
    project_card_creator_gists_url           varchar(4096) null               encoding gzip_comp,
    project_card_creator_gravatar_id         varchar(4096) null               encoding gzip_comp,
    project_card_creator_html_url            varchar(4096) null               encoding gzip_comp,
    project_card_creator_id                  int           null               encoding gzip_comp,
    project_card_creator_login               varchar(4096) null               encoding gzip_comp,
    project_card_creator_organizations_url   varchar(4096) null               encoding gzip_comp,
    project_card_creator_received_events_url varchar(4096) null               encoding gzip_comp,
    project_card_creator_repos_url           varchar(4096) null               encoding gzip_comp,
    project_card_creator_site_admin          boolean       null               encoding auto,
    project_card_creator_starred_url         varchar(4096) null               encoding gzip_comp,
    project_card_creator_subscriptions_url   varchar(4096) null               encoding gzip_comp,
    project_card_creator_type                varchar(4096) null               encoding gzip_comp,
    project_card_creator_url                 varchar(4096) null               encoding gzip_comp,
    project_card_id                          int           null               encoding gzip_comp,
    project_card_note                        varchar(4096) null               encoding gzip_comp,
    project_card_updated_at                  timestamp     null               encoding gzip_comp,
    project_card_url                         varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_project_card_1 IS 'iglu:com.github/project_card/jsonschema/1-0-0';
