...
CREATE TABLE IF NOT EXISTS atomic.com_github_release_1 (
    ...
    release_assets                       varchar(5000) null               encoding gzip_comp,
    release_assets_url                   varchar(4096) null               encoding gzip_comp,
    release_author_avatar_url            varchar(4096) null               encoding gzip_comp,
    release_author_events_url            varchar(4096) null               encoding gzip_comp,
    release_author_followers_url         varchar(4096) null               encoding gzip_comp,
    release_author_following_url         varchar(4096) null               encoding gzip_comp,
    release_author_gists_url             varchar(4096) null               encoding gzip_comp,
    release_author_gravatar_id           varchar(4096) null               encoding gzip_comp,
    release_author_html_url              varchar(4096) null               encoding gzip_comp,
    release_author_id                    int           null               encoding gzip_comp,
    release_author_login                 varchar(4096) null               encoding gzip_comp,
    release_author_organizations_url     varchar(4096) null               encoding gzip_comp,
    release_author_received_events_url   varchar(4096) null               encoding gzip_comp,
    release_author_repos_url             varchar(4096) null               encoding gzip_comp,
    release_author_site_admin            boolean       null               encoding auto,
    release_author_starred_url           varchar(4096) null               encoding gzip_comp,
    release_author_subscriptions_url     varchar(4096) null               encoding gzip_comp,
    release_author_type                  varchar(4096) null               encoding gzip_comp,
    release_author_url                   varchar(4096) null               encoding gzip_comp,
    release_body                         varchar(4096) null               encoding gzip_comp,
    release_created_at                   timestamp     null               encoding gzip_comp,
    release_draft                        boolean       null               encoding auto,
    release_html_url                     varchar(4096) null               encoding gzip_comp,
    release_id                           int           null               encoding gzip_comp,
    release_name                         varchar(4096) null               encoding gzip_comp,
    release_prerelease                   boolean       null               encoding auto,
    release_published_at                 timestamp     null               encoding gzip_comp,
    release_tag_name                     varchar(4096) null               encoding gzip_comp,
    release_tarball_url                  varchar(4096) null               encoding gzip_comp,
    release_target_commitish             varchar(4096) null               encoding gzip_comp,
    release_upload_url                   varchar(4096) null               encoding gzip_comp,
    release_url                          varchar(4096) null               encoding gzip_comp,
    release_zipball_url                  varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_release_1 IS 'iglu:com.github/release/jsonschema/1-0-0';
