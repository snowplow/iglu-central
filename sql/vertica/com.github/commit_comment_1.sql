...
-- Generated: 2018-05-03 16:26

CREATE SCHEMA IF NOT EXISTS atomic;

CREATE TABLE IF NOT EXISTS atomic.com_github_commit_comment_1 (
    ...
    comment_line                         varchar(4096) null               encoding gzip_comp,
    comment_path                         varchar(4096) null               encoding gzip_comp,
    comment_position                     varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_commit_comment_1 IS 'iglu:com.github/commit_comment/jsonschema/1-0-0';
