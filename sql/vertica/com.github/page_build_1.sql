...
CREATE TABLE IF NOT EXISTS atomic.com_github_page_build_1 (
    ...
    build_commit                         varchar(4096) null               encoding gzip_comp,
    build_created_at                     timestamp     null               encoding gzip_comp,
    build_duration                       smallint      null               encoding gzip_comp,
    build_error_message                  varchar(4096) null               encoding gzip_comp,
    build_pusher_avatar_url              varchar(4096) null               encoding gzip_comp,
    build_pusher_events_url              varchar(4096) null               encoding gzip_comp,
    build_pusher_followers_url           varchar(4096) null               encoding gzip_comp,
    build_pusher_following_url           varchar(4096) null               encoding gzip_comp,
    build_pusher_gists_url               varchar(4096) null               encoding gzip_comp,
    build_pusher_gravatar_id             varchar(4096) null               encoding gzip_comp,
    build_pusher_html_url                varchar(4096) null               encoding gzip_comp,
    build_pusher_id                      int           null               encoding gzip_comp,
    build_pusher_login                   varchar(4096) null               encoding gzip_comp,
    build_pusher_organizations_url       varchar(4096) null               encoding gzip_comp,
    build_pusher_received_events_url     varchar(4096) null               encoding gzip_comp,
    build_pusher_repos_url               varchar(4096) null               encoding gzip_comp,
    build_pusher_site_admin              boolean       null               encoding auto,
    build_pusher_starred_url             varchar(4096) null               encoding gzip_comp,
    build_pusher_subscriptions_url       varchar(4096) null               encoding gzip_comp,
    build_pusher_type                    varchar(4096) null               encoding gzip_comp,
    build_pusher_url                     varchar(4096) null               encoding gzip_comp,
    build_status                         varchar(4096) null               encoding gzip_comp,
    build_updated_at                     timestamp     null               encoding gzip_comp,
    build_url                            varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_page_build_1 IS 'iglu:com.github/page_build/jsonschema/1-0-0';
