...
CREATE TABLE IF NOT EXISTS atomic.com_github_org_block_1 (
    ...
    blocked_user_avatar_url          varchar(4096) null               encoding gzip_comp,
    blocked_user_events_url          varchar(4096) null               encoding gzip_comp,
    blocked_user_followers_url       varchar(4096) null               encoding gzip_comp,
    blocked_user_following_url       varchar(4096) null               encoding gzip_comp,
    blocked_user_gists_url           varchar(4096) null               encoding gzip_comp,
    blocked_user_gravatar_id         varchar(4096) null               encoding gzip_comp,
    blocked_user_html_url            varchar(4096) null               encoding gzip_comp,
    blocked_user_id                  int           null               encoding gzip_comp,
    blocked_user_login               varchar(4096) null               encoding gzip_comp,
    blocked_user_organizations_url   varchar(4096) null               encoding gzip_comp,
    blocked_user_received_events_url varchar(4096) null               encoding gzip_comp,
    blocked_user_repos_url           varchar(4096) null               encoding gzip_comp,
    blocked_user_site_admin          boolean       null               encoding auto,
    blocked_user_starred_url         varchar(4096) null               encoding gzip_comp,
    blocked_user_subscriptions_url   varchar(4096) null               encoding gzip_comp,
    blocked_user_type                varchar(4096) null               encoding gzip_comp,
    blocked_user_url                 varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_org_block_1 IS 'iglu:com.github/org_block/jsonschema/1-0-0';
