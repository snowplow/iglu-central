...
CREATE TABLE IF NOT EXISTS atomic.com_github_project_1 (
    ...
    project_body                         varchar(4096) null               encoding gzip_comp,
    project_columns_url                  varchar(4096) null               encoding gzip_comp,
    project_created_at                   timestamp     null               encoding gzip_comp,
    project_creator_avatar_url           varchar(4096) null               encoding gzip_comp,
    project_creator_events_url           varchar(4096) null               encoding gzip_comp,
    project_creator_followers_url        varchar(4096) null               encoding gzip_comp,
    project_creator_following_url        varchar(4096) null               encoding gzip_comp,
    project_creator_gists_url            varchar(4096) null               encoding gzip_comp,
    project_creator_gravatar_id          varchar(4096) null               encoding gzip_comp,
    project_creator_html_url             varchar(4096) null               encoding gzip_comp,
    project_creator_id                   int           null               encoding gzip_comp,
    project_creator_login                varchar(4096) null               encoding gzip_comp,
    project_creator_organizations_url    varchar(4096) null               encoding gzip_comp,
    project_creator_received_events_url  varchar(4096) null               encoding gzip_comp,
    project_creator_repos_url            varchar(4096) null               encoding gzip_comp,
    project_creator_site_admin           boolean       null               encoding auto,
    project_creator_starred_url          varchar(4096) null               encoding gzip_comp,
    project_creator_subscriptions_url    varchar(4096) null               encoding gzip_comp,
    project_creator_type                 varchar(4096) null               encoding gzip_comp,
    project_creator_url                  varchar(4096) null               encoding gzip_comp,
    project_id                           int           null               encoding gzip_comp,
    project_name                         varchar(4096) null               encoding gzip_comp,
    project_number                       smallint      null               encoding gzip_comp,
    project_owner_url                    varchar(4096) null               encoding gzip_comp,
    project_state                        varchar(4096) null               encoding gzip_comp,
    project_updated_at                   timestamp     null               encoding gzip_comp,
    project_url                          varchar(4096) null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_project_1 IS 'iglu:com.github/project/jsonschema/1-0-0';
