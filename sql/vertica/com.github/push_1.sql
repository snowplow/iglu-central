...
CREATE TABLE IF NOT EXISTS atomic.com_github_push_1 (
    ...
    after                          varchar(4096) null               encoding gzip_comp,
    base_ref                       varchar(4096) null               encoding gzip_comp,
    before                         varchar(4096) null               encoding gzip_comp,
    commits                        varchar(5000) null               encoding gzip_comp,
    compare                        varchar(4096) null               encoding gzip_comp,
    created                        boolean       null               encoding auto,
    deleted                        boolean       null               encoding auto,
    forced                         boolean       null               encoding auto,
    head_commit_added              varchar(5000) null               encoding gzip_comp,
    head_commit_author_email       varchar(4096) null               encoding gzip_comp,
    head_commit_author_name        varchar(4096) null               encoding gzip_comp,
    head_commit_author_username    varchar(4096) null               encoding gzip_comp,
    head_commit_committer_email    varchar(4096) null               encoding gzip_comp,
    head_commit_committer_name     varchar(4096) null               encoding gzip_comp,
    head_commit_committer_username varchar(4096) null               encoding gzip_comp,
    head_commit_distinct           boolean       null               encoding auto,
    head_commit_id                 varchar(4096) null               encoding gzip_comp,
    head_commit_message            varchar(4096) null               encoding gzip_comp,
    head_commit_modified           varchar(5000) null               encoding gzip_comp,
    head_commit_removed            varchar(5000) null               encoding gzip_comp,
    head_commit_timestamp          timestamp     null               encoding gzip_comp,
    head_commit_tree_id            varchar(4096) null               encoding gzip_comp,
    head_commit_url                varchar(4096) null               encoding gzip_comp,
    pusher_email                   varchar(4096) null               encoding gzip_comp,
    pusher_name                    varchar(4096) null               encoding gzip_comp,
    ref                            varchar(4096) null               encoding gzip_comp,
    ...
    repository_created_at          int           null               encoding gzip_comp,
    ...
    repository_master_branch       varchar(4096) null               encoding gzip_comp,
    ...
    repository_owner_email         varchar(4096) null               encoding gzip_comp,
    repository_owner_name          varchar(4096) null               encoding gzip_comp,
    repository_private             boolean       null               encoding auto,
    repository_pulls_url           varchar(4096) null               encoding gzip_comp,
    repository_pushed_at           int           null               encoding gzip_comp,
    ...
    repository_stargazers          smallint      null               encoding gzip_comp,
...
COMMENT ON TABLE atomic.com_github_push_1 IS 'iglu:com.github/push/jsonschema/1-0-0';
