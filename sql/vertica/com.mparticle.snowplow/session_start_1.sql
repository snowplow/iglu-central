...
CREATE TABLE IF NOT EXISTS atomic.com_mparticle_snowplow_session_start_1 (
    -- Schema of this type
...
COMMENT ON TABLE atomic.com_mparticle_snowplow_session_start_1 IS 'iglu:com.mparticle.snowplow/session_start/jsonschema/1-0-0';
