CREATE TABLE IF NOT EXISTS atomic.com_mparticle_snowplow_appstatetransition_event_1 (
	-- Schema of this type
	...
	transitionType		varchar(255)		not null    		encoding gzip_comp   ,
	isFirstRun  		boolean     		null        		encoding auto        ,
	isUpgrade   		boolean     		null        		encoding auto        ,
	launchParams		varchar(255)		null        		encoding gzip_comp   ,
	launchReferral		varchar(255)		null        		encoding gzip_comp   ,
	successfullyClosed		boolean     		null        		encoding auto        ,
	jsonPayload 		number      		null        		encoding auto        ,
	referralApplication		number      		null        		encoding auto        ,
