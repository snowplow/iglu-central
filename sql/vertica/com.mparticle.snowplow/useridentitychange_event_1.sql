CREATE TABLE IF NOT EXISTS atomic.com_mparticle_snowplow_useridentitychange_event_1 (
	-- Schema of this type
	...
	newIdentity 		varchar(4096)		null        		encoding gzip_comp   ,
	oldIdentity 		varchar(4096)		null        		encoding gzip_comp   
)
ORDER BY
	schema_vendor,
	schema_name,
