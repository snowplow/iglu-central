...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_bounce_1 (
    ...
    cert_error                         varchar(4096) null               encoding gzip_comp,
    ...
    reason                             varchar(4096) null               encoding gzip_comp,
    ...
    status                             varchar(4096) null               encoding gzip_comp,
    "timestamp"                        timestamp     null               encoding gzip_comp,
    tls                                varchar(4096) null               encoding gzip_comp,
    type                               varchar(4096) null               encoding gzip_comp,
