CREATE TABLE IF NOT EXISTS atomic.com_snowplowanalytics_snowplow_social_interaction_1 (
	-- Schema of this type
	...
	network     		varchar(255)		not null    		encoding gzip_comp   ,
	target      		varchar(255)		null        		encoding gzip_comp   
)
ORDER BY
	schema_vendor,
	schema_name,
