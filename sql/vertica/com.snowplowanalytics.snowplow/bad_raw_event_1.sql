CREATE TABLE IF NOT EXISTS atomic.com_snowplowanalytics_snowplow_bad_raw_event_1 (
	-- Schema of this type
	...
	line        		varchar(255)		not null    		encoding gzip_comp   ,
	errors      		varchar(4096)		not null    		encoding gzip_comp   
)
ORDER BY
	schema_vendor,
	schema_name,
