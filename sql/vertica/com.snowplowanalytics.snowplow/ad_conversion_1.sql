CREATE TABLE IF NOT EXISTS atomic.com_snowplowanalytics_snowplow_ad_conversion_1 (
	...
	conversionId		varchar(255)		null        		encoding gzip_comp   ,
	...
	action      		varchar(255)		null        		encoding gzip_comp   ,
	property    		varchar(255)		null        		encoding gzip_comp   ,
	costModel   		varchar(255)		null        		encoding gzip_comp   ,
	cost        		number      		null        		encoding auto        ,
	initialValue		number      		null        		encoding auto        
)
ORDER BY
	schema_vendor,
	schema_name,
